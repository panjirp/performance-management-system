  ...
  <div class="content content-fixed content-auth">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
          <div>
            ...
            <h4 class="mg-b-0 tx-spacing--1">Master Data Department</h4>
          </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalDeleteLabel">Hapus Data Department</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              Apakah kamu yakin untuk hapus data department?
            </div>
            <div class="modal-footer">  
              <form action="<?php echo base_url('master/delete_department'); ?>" method="post">            
                <input id="deptId" name="deptId" style="display:none">
            ...
            <table class="table table-striped" id="departmentTable">
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td><?php echo $i + 1; ?></td>
                    <td><?php echo $department[$i]->name; ?></td>
                    <td>
                      <!-- Edit -->
                      <a href="<?php echo base_url('master/edit_department/'.$department[$i]->id); ?>">
                      <button type="button ml-2" class="btn-edit ml-3"><i class="fa fa-cog" aria-hidden="true"></i>
                        Edit
                      </button>
                      </a>
                      <!-- Delete -->
                      <button type="button ml-2" data-id="<?php echo $department[$i]->id; ?>" data-toggle="modal" data-target="#modalDelete" class="openModalDelete btn-delete ml-3"><i class="fa fa-trash" aria-hidden="true"></i>
                        Hapus
                      </button>
                    </td>
                  </tr>
...
<script>
  $(document).ready( function () {
    table1 = $('#departmentTable').DataTable({
      language: {
